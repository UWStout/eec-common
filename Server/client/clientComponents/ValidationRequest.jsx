...
import { requestValidation } from '../authHelper.js'
  ...
  const submitValidationRequest = async () => {
    ...
    try {
      ...
      if (err?.response?.status === 429) {
        ...
        window.alert(`Error requesting validation. Please contact an administrator for help.\n\n(Info: ${message})`)
      }
    }
  }
  ...
  return (
    <div className={classes.layout}>
      ...
      <Typography variant="body1">
        ...
        {'a new email validation request will be sent to that address.'}
        <br />
        <br />
      </Typography>
      <Paper elevation={1}>
