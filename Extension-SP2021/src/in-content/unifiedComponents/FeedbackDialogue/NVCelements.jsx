...
export function Observation () {
  return (
    <Typography aria-label='title' variant='body2'>
      ...
      <a href="https://www.cnvc.org/training/resource/book-chapter-1"> The Center for Nonviolent Communication</a>
    </Typography>
  )
}
...
export function Feeling () {
  return (
    <Typography aria-label='title' variant='body2'>
      ...
      <br />
      For more information, check out this link:
      <a target="_blank" href="https://www.cnvc.org/training/resource/book-chapter-1" rel="noreferrer">The Center for Nonviolent Communication</a>
      .
    </Typography>)
}
