...
import EECBubbleCSS from './EECBubbleStyle.txt'
...
class EECBubble extends HTMLElement {
  constructor () {
  ...
  setupElement () {
    ...
    this.customStyle.text(EECBubbleCSS)

    // Insert icon from defined attribute or default icon
    this.imageIcon = jQuery('<img>')
    this.imageIcon.attr('id', 'EECButton')
    this.imageIcon.attr('src', EECBubble.DEFAULT_IMG)
    this.imageIcon.addClass('eec-bubble-icon')
    ...
    this.alertIcon.addClass('eec-bubble-icon animate__animated animate__fadein')

    // Container for the icon and popover
    this.popover = jQuery('<div>')
    this.popover.addClass('eec-bubble')
